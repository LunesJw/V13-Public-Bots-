...
${client.emojis.cache.find(x => x.name === "mavinokta")} Toplam Puanınız: \`${coinData ? Math.floor(coinData.coin) : 0} Puan\`
${client.emojis.cache.find(x => x.name === "mavinokta")} Seste Puanınız: \`${moment.duration(voiceData ? voiceData.topStat : 0).format("h")*240} Puan\`
${client.emojis.cache.find(x => x.name === "mavinokta")} Yetkili Puanınız: \`${yetkiData ? yetkiData.yetkis.length*30 : 0} Puan\`
${client.emojis.cache.find(x => x.name === "mavinokta")} Taglı Puanınız: \`${taggedData ? taggedData.taggeds.length*25 : 0} Puan\`
${client.emojis.cache.find(x => x.name === "mavinokta")} Davet Puanınız: \`${total*15} Puan\`
${client.emojis.cache.find(x => x.name === "mavinokta")} Kayıt Puanınız: \`${toplamData ? toplamData.toplams.length*5.5 : 0} Puan\`
`, false)
...
${client.emojis.cache.find(x => x.name === "mavinokta")} yetkili belirleyerek, \`+30\` puan kazanırsın.
