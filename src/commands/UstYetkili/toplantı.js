...
{
message.react(red)
message.channel.send(`Mazaretli birisini belirtmek için : **.toplantı mazeretli**. Toplantı başlatmak için **.toplantı başlat**.`)
return
}
...
if(!member) {
message.react(red)
message.channel.send(`Kimin mazeretli olduğunu belirtmeyi unuttun dostum.`)
return
}
